...
class Message {
  ...
  Message.fromJson(Map<String, dynamic> json)
      : msgId = json['msgId'],
        ...
        video =
            json['video'] != null ? VideoElement.fromJson(json['video']) : null,
        sound =
...
class VideoElement {
  ...
  VideoElement.fromJson(Map<String, dynamic> json)
      : video = json['videoUrl'],
        videoWidth = json['videoWidth']?.toDouble(),
        videoHeight = json['videoHeight']?.toDouble(),
