  ...
  Widget buildItemView() {
    ...
    switch (widget.message.contentType) {
      ...
      case MessageType.video:
        {
          print('=============video string ============');
          print(widget.message.video?.video.toString());
          child = _buildCommonItemView(
            child: ChatVideoView(
              msgId: widget.message.msgId!,
              msgProgressControllerStream: widget.msgSendProgressSubjectStream,
              videoUrl: widget.message.video!.video!,
              isFromMsg: isFromMsg,
              videoWidth: widget.message.video!.videoWidth!,
              videoHeight: widget.message.video!.videoHeight!,
            ),
          );
        }
        break;
