...
class ChatLogic extends GetxController {
    ...
    if (assetEntity != null) {
      ...
      switch (assetEntity.type) {
        ...
        case AssetType.video:
          //upload video
          sendVideo(videoFile: file, videoName: name);
          break;
        default:
          break;
      }
  ...
  void sendPicture({required File imageFile, required String imageName}) async {
    ...
    print(imageElement.toString());
    print('=============_sendMessage imgs message ============');
    print(message.toString());
    _sendMessage(message);
  }

  // 写一个sendVideo 方法
  void sendVideo({required File videoFile, required String videoName}) async {
    print('=============sendVideo imageFile ============');
    ...
    if (kDebugMode) {
      print("videoPath:${videoFile.path}");
    }
    var data = await Apis.uploadFile(
